...
1. Explain what a token is used for.
  Tokens are used to access private routes that are not accessible without user authentication.
2. What steps can you take in your web apps to keep your data secure?
  Making sensitive routes private and using authentication login
3. Describe how web servers work.
  Requests are sent, takes data and returns it for the App to manipulate and use it.
